...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:         
        ...
        results_stats_dic['n_correct_breed'] +=results_dic[key][2] and results_dic[key][3]
        #         li    #         for k in  resulic:
        #             if results_di[3]==1:
        #                  if results_diy][2] == 1:
        #                         results_stats_dic['n_correct_breed'] += 1        
        # Pet Image Label is a Dog - counts number of dog images
        #         results_stats_dic['n_dogs_img'] +=results_dic[key][3]==1
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
            
        # Classifier classifies image as Dog (& pet image is a dog)
        # counts number of correct dog classifications
        results_stats_dic['n_correct_dogs'] +=results_dic[key][4] and results_dic[key][3]
        ...
        #         else:
        #             results_stats_dic['n_correct_notdogs'] +=results_dic[key][3]==0 and results_dic[key][4]
