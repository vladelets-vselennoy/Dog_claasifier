...
#                                                                             
# PROGRAMMER:Raghuraj Pratap Yadav
# DATE CREATED:  04 november 2023                                
# REVISED DATE: 
...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Pet Image Label is NOT a Dog
             ...
             for k in  results_dic:
                    if results_dic[k][3]==0 and results_dic[key][4] == 0 :
    ...
    if results_stats_dic['n_images']>0:
        results_stats_dict['pct_match']=results_stats_dic['n_match']/results_stats_dict['n_dogs_img']*100
    ...
    if results_stats_dic['n_dogs_img']>0:
        results_stats_dict['pct_correct_dogs']=results_stats_dic['n_correct_dogs']/results_stats_dict['n_dogs_img']*100
    ...
    if results_stats_dic['n_dogs_img']>0:
        results_stats_dict['pct_correct_breed']=results_stats_dic['n_correct_breed']/results_stats_dict['n_dogs_img']*100
